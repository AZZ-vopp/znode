...
contains "$installer" 'systemctl is-active --quiet znode'
not_contains "$installer" 'systemctl status znode | grep Active'
contains "$manager" 'systemctl is-active --quiet znode'
not_contains "$manager" 'systemctl status znode | grep Active'
